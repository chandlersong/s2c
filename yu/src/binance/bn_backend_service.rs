...
use crate::binance::bn_duck_db::{BinanceKlineDataExecutor, DuckDBOneTable, DuckTableTableListener};
...
pub(crate) static RAW_SPOT_BINANCE_KLINE_TABLE: OnceLock<DuckTableTableListener<KlinePo>> = OnceLock::new();

pub fn get_raw_spot_kline_table() -> DuckTableTableListener<KlinePo> {
